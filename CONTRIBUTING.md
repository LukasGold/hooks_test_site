...
Welcome to `hooks_test_site` contributor's guide.
...
If you experience bugs or general issues with `hooks_test_site`, please have a look
...
You can help improve `hooks_test_site` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`hooks_test_site` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `hooks_test_site`'s files. While this mechanism can
...
```
conda create -n hooks_test_site python=3 six virtualenv pytest pytest-cov
conda activate hooks_test_site
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/hooks_test_site.git
   cd hooks_test_site
   ```
...
5. Install [pre-commit]:
   ...
   `hooks_test_site` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/hooks_test_site
[issue tracker]: https://github.com/<USERNAME>/hooks_test_site/issues
